...
This project was created when we found that off-the-shelf moisture sensors
consume their batteries in just a week, if left in the plant all the time.  There 
were about 60 total moisture sensors, so changing batteries at that pace wasn't 
